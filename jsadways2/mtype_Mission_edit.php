	...
	<?php include("public/topbar.php"); ?>
		...
		<div class="row-fluid">
			...
			<?php
				...
				$sql2 = "SELECT * FROM media169 WHERE id= ".$_GET['id'];
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-edit"></i> <?php echo $row1['name']; ?>-編輯媒體-錢包小豬(任務型)</h2>
						  ...
						  <fieldset>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								 ...
								 <!--
                                 <option value="android" <?php if($row2['phonesystem']=='android'){echo 'selected';} ?>>android</option>
                                 <option value="iOS" <?php if($row2['phonesystem']=='iOS'){echo 'selected';} ?>>iOS</option>
                                 -->
							    </select>
							  </div>
							</div>
