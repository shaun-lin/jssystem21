<?php
	...
	$sqlnew = "SELECT * FROM media71 ORDER BY id DESC LIMIT 1;";
	...
	$sql2='INSERT INTO media166(campaign_id,cue,website,totalprice,a4,a3,a0,a,a5,times,others,status,items2,items3) VALUES('.$_GET['id'].',2,"Youtuber費","'.$_POST['totalprice'].'","'.$_POST['totalprice2'].'","'.$_POST['totalprice3'].'","'.$a0.'","71","'.$a5.'",'.time().',"'.$_POST['others'].'",0,"'.$TypeItem.'","'.$_POST['SelectSystem'].'")';
	mysql_query($sql2);
	AddMediaMapping('media166', $_GET['id'], mysql_insert_id());
