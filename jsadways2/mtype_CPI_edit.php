			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-edit"></i> <?php echo $row1['name']; ?>-編輯媒體-Adways Asia</h2>

					</div>
					<div class="box-content">
						<form class="form-horizontal" action="mtype_CPI_edit2.php?campaign=<?php echo $_GET['campaign']; ?>&id=<?php echo $_GET['id']; ?>&cue=<?php echo $_GET['cue']; ?>&media=<?php echo $_GET['media']; ?>" method="post">
							<?php
									$sql1 = "SELECT * FROM campaign WHERE id= ".$_GET['campaign'];
									$result1 = mysql_query($sql1);
									$row1 = mysql_fetch_array($result1);
									$sql2 = "SELECT * FROM media".$_GET['media']." WHERE id= ".$_GET['id'];
                            ...
                            $(document).ready(function()
								...
								function Page_Init()
								{
									...
									$('#SelectCategory').empty().append($('<option></option>').val('<?php echo $row2['phonesystem']; ?>').text('<?php echo $row2['phonesystem']; ?>'));
						  ...
						  <fieldset>
                              ...
                              <div class="control-group">
                                ...
                                <div class="controls">
								<input class="input-xlarge" id="actions" name="actions" value="<?php echo $row2['actions']; ?>" type="text" >輸入投放地區，如有多地區請用逗號(，)分隔
                                </div>
                              </div>
                              <div class="control-group">
