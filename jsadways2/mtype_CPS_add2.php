<?php
	...
	$sql2='INSERT INTO media156(item_seq,campaign_id,cue,website,actions,phonesystem,position,format1,format2,wheel,date1,date2,date3,date4,date5,date6,date7,date8,date9,date10,days,due,quantity,price,totalprice,times,others,a,a0,a1,a2,a3,a4,a5,items2,items3) VALUES('.$autoSerialNumberA.','.$_GET['id'].','.$_GET['cue'].',"'.$_GET['media_name'].'","'.$_POST['actions'].'","'.$_POST['phonesystem'].'","'.$_POST['position'].'","'.$_POST['format1'].'","'.$_POST['format2'].'","'.$_POST['wheel'].'",'.$date[1].','.$date[2].','.$date[3].','.$date[4].','.$date[5].','.$date[6].','.$date[7].','.$date[8].','.$date[9].','.$date[10].',"'.$_POST['days'].'","'.$_POST['due'].'","'.$_POST['quantity'].'","'.$_POST['price'].'","'.$totalprice.'",'.time().',"'.$_POST['others'].'","'.$a.'","'.$a0.'","'.$a1.'","'.$a2.'","'.$a3.'","'.$a4.'","'.$a5.'","'.$TypeItem.'","'.$_POST['SelectSystem'].'")';
	mysql_query($sql2);
	AddMediaMapping("media156", $_GET['id'], mysql_insert_id());
	...
	if($_POST['samecue']==1){
		...
		$sqlnew = "SELECT * FROM media156 ORDER BY id DESC LIMIT 1;";
		...
		$sql2='INSERT INTO media156(item_seq,campaign_id,cue,website,actions,phonesystem,position,format1,format2,wheel,date1,date2,date3,date4,date5,date6,date7,date8,date9,date10,days,due,quantity,price,totalprice,times,others,a,a0,a1,a2,a3,a4,items2,items3) VALUES('.$autoSerialNumberB.','.$_GET['id'].',2,"'.$_GET['media_name'].'","'.$_POST['actions'].'","'.$_POST['phonesystem'].'","'.$_POST['position'].'","'.$_POST['format1'].'","'.$_POST['format2'].'","'.$_POST['wheel'].'",'.$date[1].','.$date[2].','.$date[3].','.$date[4].','.$date[5].','.$date[6].','.$date[7].','.$date[8].','.$date[9].','.$date[10].',"'.$_POST['days'].'","'.$_POST['due'].'","'.$_POST['quantity'].'","'.$_POST['price'].'","'.$_POST['totalprice'].'",'.time().',"'.$_POST['others'].'","'.$a.'","'.$a0.'","'.$a1.'","'.$a2.'","'.$a3.'","'.$a4.'","'.$TypeItem.'","'.$_POST['SelectSystem'].'")';
		mysql_query($sql2);
		AddMediaMapping("media156", $_GET['id'], mysql_insert_id());
