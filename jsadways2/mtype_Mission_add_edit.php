<fieldset>
                              ...
                              <div class="control-group">
                                ...
                                <div class="controls">
                                  <input class="input-xlarge" id="actions" name="actions" type="text"  value="CPF(粉絲團按讚)" readonly>
                                </div>
                              </div>
							...
							function Page_Init()
							{
									...
									[
										{
											"TypeItemId": "1",
											"TypeItemName": "小豬啦啦隊-粉絲團按讚CPF"
										},
										{
											"TypeItemId": "2",
											"TypeItemName": "口碑培養皿-文章分享CPS"
										},
										{
											"TypeItemId": "3",
											"TypeItemName": "小豬特派員-心得撰寫CPA"
										}
									];
									...
									{
										$('#position').append($('<option></option>').val(item.TypeItemId).text(item.TypeItemName));
									});
								...
								function ChangePosition(){
									...
									switch(categoryId){
										case '1':
											$('#actions').val('CPF(粉絲團按讚)');
											<?php
												$sqlsize = "SELECT * FROM sizeformat WHERE id =188";
											...
											document.getElementById('others').value = "<?php echo $rowsize['adtype']; ?>";
										break;

										case '2':
											$('#actions').val('CPS(文章分享)');
											<?php
												$sqlsize = "SELECT * FROM sizeformat WHERE id =189";
												$resultsize = mysql_query($sqlsize);
												$rowsize = mysql_fetch_array($resultsize);
											?>
											document.getElementById('format1').value = "<?php echo $rowsize['format1']; ?>";
										...
										case '3':
											$('#actions').val('CPA(心得撰寫)');
											<?php
												$sqlsize = "SELECT * FROM sizeformat WHERE id =190";
												$resultsize = mysql_query($sqlsize);
												$rowsize = mysql_fetch_array($resultsize);
											?>
											document.getElementById('format1').value = "<?php echo $rowsize['format1']; ?>";
								...
								function ChangeSelectType(){
									...
									var categoryId = $.trim($('#SelectSystem option:selected').val());


									if(categoryId == 'iOS' || categoryId == 'Android')
									{
							...
							<div class="control-group">
                              ...
                              <div class="control-group">
                                ...
                                <div class="controls">
                                <!--
                                  <input class="input-xlarge" id="position" name="position" type="text"  value="Offer Wall" readonly>
                                -->
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<span style="color:red;">(回饋獎金型-CPF 定價低於2.5會異常，回饋獎金型-CPS定價 低於7.5會異常，回饋獎金型-CPA 定價低於150會異常)</span>
							  </div>
							</div>
							<div class="control-group">
							...
							<div class="control-group">
								...
								<div class="controls">
                                  <input class="datepicker" id="due" name="due" type="text"  value="上線前3日"  style="width:100px" >
								</div>
							  </div>
							<div class="control-group">
