<?php
	...
	$sql2 = "INSERT INTO `media153` (". implode(', ', $fieldsNameForCue1) .") VALUES (". implode(', ', $fieldsVarForCue1) .");";
	$db->query($sql2);
	AddMediaMapping("media153", $_GET['id'], $db->get_last_insert_id());
	...
	if ($_POST['samecue'] == 1) {
		...
		$sql2 = "INSERT INTO `media153` (". implode(', ', $fieldsNameForCue2) .") 
