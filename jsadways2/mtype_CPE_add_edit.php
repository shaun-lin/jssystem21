...
<script type="text/javascript">
    ...
    <? for ($i=1; $i<=5; $i++) : ?>
        ...
        function change<?= $i.$i; ?>()
        {
            document.getElementById('price<?= $i; ?>').value = document.getElementById('totalprice<?= $i; ?>').value / document.getElementById('click<?= $i; ?>').value;
            change();
        }
        ...
        function change<?= $i; ?>()
        {
            ...
            <? if ($_GET['cue'] == 2) : ?>
                document.getElementById('price<?= $i; ?>').value = (document.getElementById('totalprice<?= $i; ?>').value * 1000) / document.getElementById('impression<?= $i; ?>').value;
            <? endif; ?>
...
<fieldset>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input class="input-xlarge" id="ctr" name="ctr" type="text" value="<?= isset($row2['ctr']) ? $row2['ctr'] : '0.2'; ?>" onChange="number()" style="width:100px">%
        </div>
    </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                ...
                <? if (isset($editMode) && $_GET['cue'] == 2 && (strlen($$varClick1Alias) || strlen($$varTotalprice1Alias))) : ?>
                    <font color="#FF0000">*總價及預估點擊欄位非系統自動換算，請自行確認數字是否正確</font>
                <? endif; ?>
            </div>
        </div>
    <? endfor; ?>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input id="due" name="due" type="text" value="<?= isset($row2['due']) ? $row2['due'] : '開始刊登日之5個工作天前的16時(台灣時間)為止入稿'; ?>" style="width: 200px;">
        </div>
    </div>
    ...
    <div class="control-group">
        <label class="control-label" for="number1">保證點擊數(Est. Clicks)</label>
        <div class="controls">
