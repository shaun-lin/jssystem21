			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-edit"></i> <?php echo $row1['name']; ?>-編輯媒體-預約TOP10</h2>
					...
					<div class="box-content">
						<?php
							...
							$sql2 = "SELECT * FROM media168 WHERE id= ".$_GET['id'];
							$result2 = mysql_query($sql2);
							$row2 = mysql_fetch_array($result2);
						?>
						<form class="form-horizontal" action="mtype_TOPTen_edit2.php?campaign=<?php echo $_GET['campaign']; ?>&id=<?php echo $_GET['id']; ?>&cue=<?php echo $_GET['cue']; ?>&media=<?php echo $_GET['media']; ?>" method="post">
						  <fieldset>
                          	<div class="control-group">
							   ...
							   <div class="control-group">
								...
								<div class="controls">
								  <input class="input-xlarge" id="actions" name="actions" type="text" value="<?php echo $row2['actions']; ?>" readonly>
								</div>
							  </div>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								 <select id="phonesystem" name="phonesystem">
								 	<!--
								 	<option value="iOS" <?php if($row2['phonesystem']=="iOS"){echo 'selected="selected"';} ?>>iOS</option>
								 	<option value="Android" <?php if($row2['phonesystem']=="Android"){echo 'selected="selected"';} ?>>Android</option>
							    	-->
							    </select>
							  </div>
							</div>
							...
							<div class="control-group">
							  <label class="control-label" for="SelectSubCategory">版位(Position)</label>
							  <div class="controls">
								<input class="input-xlarge" id="position" name="position" type="text" value="<?php echo $row2['position']; ?>" style="width:100px" readonly>
							  </div>
							</div>
							  <div class="control-group">
