<?php
	...
	require_once 'mtype_FBFee_definition.php';
    ...
    $sql2 = "INSERT INTO `media". $mediaOrdinal ."` (". implode(', ', $fieldsNameForCue1) .") VALUES (". implode(', ', $fieldsVarForCue1) .");";
	$db->query($sql2);
	AddMediaMapping('media163', $_GET['id'], $db->get_last_insert_id());
