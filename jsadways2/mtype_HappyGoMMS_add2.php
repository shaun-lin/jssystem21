<?php
	...
	$sql2='INSERT INTO media165(campaign_id,
item_seq,
cue,
website,
channel,
...
"'.$_POST['SelectSystem'].'")';
	mysql_query($sql2);
	AddMediaMapping('media165', $_GET['id'], mysql_insert_id());
	if($_POST['samecue']==1){
		$sql1 = "SELECT * FROM campaign WHERE id= ".$_GET['id'];
		$result1 = mysql_query($sql1);
		$row1 = mysql_fetch_array($result1);
		$sqlnew = "SELECT * FROM media165 ORDER BY id DESC LIMIT 1;";
...
"'.$_POST['SelectSystem'].'")';
	...
	$row1 = mysql_fetch_array($result1);
	if($row1['status']==5){
		$sql2='INSERT INTO campaignstatus2(name,data,times,campaignid) VALUES("'.$_SESSION['username'].'","新增HappyGo MMS媒體",'.time().','.$_GET['id'].')';
		mysql_query($sql2);
	}
	$cp_id = $_GET['id'];
