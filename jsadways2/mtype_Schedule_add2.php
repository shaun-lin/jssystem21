...
$sql2 = 'INSERT INTO media157(campaign_id,
item_seq,
cue,
website,
channel,
...
"' . $_POST['taget'] . '")';
mysql_query($sql2);
AddMediaMapping("media157", $_GET['id'], mysql_insert_id());
...
if ($_POST['samecue'] == 1) {
    ...
    $sqlnew = "SELECT * FROM media157 ORDER BY id DESC LIMIT 1;";
