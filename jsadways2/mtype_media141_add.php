			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-edit"></i> <?php echo $row1['name']; ?>-新增媒體-Adways Asia</h2>

					</div>
					<div class="box-content">
						<form class="form-horizontal" action="mtype_media141_add2.php?id=<?php echo $_GET['id']; ?>&cue=<?php echo $_GET['cue']; ?>&media2=<?php echo $_GET['media2']; ?>&media=<?php echo $_GET['media']; ?>&mediaid=<?php echo $_GET['mediaid']; ?>" method="post">
						  <fieldset>

                          	  <div class="control-group">
                                <label class="control-label">項目(Website)</label>
                                <div class="controls">
                                  <input class="input-xlarge" id="website" name="website" type="text" value="Adways Asia" readonly>
                                </div>
                              </div>
                              <div class="control-group">
							...
							function Page_Init()
							{
								document.getElementById('format1').value = "1.規格請先到＜無誘因媒體詢量表＞參考各無誘因媒體的規範：https://docs.google.com/spreadsheets/d/1XkeosKMBX6njsau7D4CymZHs-VgpHKQ-8xbsI_yViCQ/edit#gid=0\n2.如有＜無誘因媒體詢量表＞內找不到的資訊或其他規格問題，請洽媒體部";
								document.getElementById('format2').value = "1.<500MB\n2.圖片素材：JPG；PNG；GIF\n3.影音素材格式﹐請到＜無誘因媒體詢量表＞參考相關規範：https://docs.google.com/spreadsheets/d/1XkeosKMBX6njsau7D4CymZHs-VgpHKQ-8xbsI_yViCQ/edit#gid=0";
							...
							//Abow function
								function ChangeSelectType(){
									...
									if(categoryId == 'GAME APP' || categoryId == 'GAME APP')
									{
							...
							<div class="control-group">
                              ...
                              <div class="control-group">
                                ...
                                <div class="controls">
                                  <input class="input-xlarge" id="position" name="position" type="text"  value="非獎勵型-CPI" readonly>
                                </div>
                              </div>
                              <div class="control-group">
                                <label class="control-label">規格(Size)</label>
                                <div class="controls">
                                  <textarea id="format1" name="format1" readonly>app store/google play連結
*APP必須是以上線的APP</textarea>
                                </div>
                              </div>
                              <div class="control-group">
                                <label class="control-label">格式(Format)</label>
                                <div class="controls">
                                  <textarea id="format2" name="format2" readonly>URL</textarea>
                                </div>
                              </div>
							  <div class="control-group">
							...
							<div class="control-group">
							  <label class="control-label" for="wheel"></label>
							  <div class="controls">
							...
							<div class="control-group">
								...
								<div class="controls">
                                  <input class="datepicker" id="due" name="due" type="text"  value="7個工作天前"  style="width:300px" readonly>
								</div>
							  </div>
							<div class="control-group">
