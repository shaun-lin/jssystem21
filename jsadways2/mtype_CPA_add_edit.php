					  	...
					  	<fieldset>
							...
							<div class="control-group">
                          	...
                          	<div class="control-group">
								...
								<div class="controls">
								  <input class="input-xlarge" id="website" name="website" type="text" value="好康巴士">
								</div>
							  </div>
							...
							<div class="control-group">
								...
								<div class="controls">
								  <input class="input-xlarge" id="actions2" name="actions2" type="text" value="">
								</div>
							  </div>
							<div class="control-group">
							  ...
							  <div class="control-group">
								...
								<div class="controls">
                                  <textarea id="format1" name="format1" readonly>請提供粉絲團連結</textarea>
								</div>
							  </div>
							  ...
							  <div class="control-group">
								...
								<div class="controls">
                                <textarea id="format2" name="format2" readonly>請提供粉絲團連結</textarea>
								</div>
							  </div>
                            ...
                            <div class="control-group">
							  ...
							  <div class="controls">
								<input class="input-xlarge" id="quantity" name="quantity" onChange="number()"  type="text" value="" style="width:100px" required>
							  </div>
							</div>
                             <?php if($_GET['cue']==2){ ?>
                           <div class="control-group">
                            ...
                            <div class="control-group">
							  ...
							  <div class="controls">
								<input name="samecue" type="checkbox" value="1" checked="CHECKED">勾選後即會在對內cue表產生同筆媒體
							  </div>
							</div>
							<?php }?>
