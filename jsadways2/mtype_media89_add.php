			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						<form class="form-horizontal" action="media89_add2.php?id=<?php echo $_GET['id']; ?>&cue=<?php echo $_GET['cue']; ?>&media=<?php echo $_GET['media']; ?>&media2=<?php echo $_GET['media2']; ?>&mediaid=<?php echo $_GET['mediaid']; ?>" method="post">
						  <fieldset>
