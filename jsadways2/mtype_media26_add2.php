<?php
	...
	$sqlmedia = "SELECT * FROM media WHERE id=26";
	...
	$sql2='INSERT INTO media26(campaign_id,cue,website,actions,actions2,position,format1,format2,wheel,date1,date2,date3,date4,date5,date6,date7,date8,date9,date10,days,due,quantity,totalprice,times,others,days1,days2,days3,days4,days5,price1,price2,price3,price4,price5,totalprice1,totalprice2,totalprice3,totalprice4,totalprice5,click1,click2,click3,click4,click5,a,a0,a1,a2,a3,a4,a5,items2,items3) VALUES('.$_GET['id'].','.$_GET['cue'].',"'.$_POST['website'].'","'.$_POST['actions'].'","'.$_POST['actions2'].'","'.$_POST['position'].'","'.$_POST['format1'].'","'.$_POST['format2'].'","'.$_POST['wheel'].'",'.$date[1].','.$date[2].','.$date[3].','.$date[4].','.$date[5].','.$date[6].','.$date[7].','.$date[8].','.$date[9].','.$date[10].',"'.$_POST['days'].'","'.$_POST['due'].'","'.$_POST['quantity'].'","'.$totalprice.'",'.time().',"'.$_POST['others'].'","'.$_POST['days1'].'","'.$_POST['days2'].'","'.$_POST['days3'].'","'.$_POST['days4'].'","'.$_POST['days5'].'","'.$_POST['price1'].'","'.$_POST['price2'].'","'.$_POST['price3'].'","'.$_POST['price4'].'","'.$_POST['price5'].'","'.$_POST['totalprice1'].'","'.$_POST['totalprice2'].'","'.$_POST['totalprice3'].'","'.$_POST['totalprice4'].'","'.$_POST['totalprice5'].'","'.$_POST['click1'].'","'.$_POST['click2'].'","'.$_POST['click3'].'","'.$_POST['click4'].'","'.$_POST['click5'].'","'.$a.'","'.$a0.'","'.$a1.'","'.$a2.'","'.$a3.'","'.$a4.'","'.$a5.'","'.$TypeItem.'","'.$_POST['SelectSystem'].'")';
	mysql_query($sql2);
	AddMediaMapping("media26", $_GET['id'], mysql_insert_id());
	if($_POST['samecue']==1){
		$sql1 = "SELECT * FROM campaign WHERE id= ".$_GET['id'];
		$result1 = mysql_query($sql1);
		$row1 = mysql_fetch_array($result1);
		$sqlnew = "SELECT * FROM media26 ORDER BY id DESC LIMIT 1;";
