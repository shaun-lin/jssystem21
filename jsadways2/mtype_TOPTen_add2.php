...
$sqlmedia = "SELECT * FROM media WHERE id=168";
...
$sql2 = 'INSERT INTO media168(campaign_id,
item_seq,
cue,
website,
actions,
...
"' . $_POST['SelectSystem'] . '")';
mysql_query($sql2);
AddMediaMapping('media168', $_GET['id'], mysql_insert_id());
...
if ($_POST['samecue'] == 1) {
    ...
    $sqlnew = "SELECT * FROM media168 ORDER BY id DESC LIMIT 1;";
...
$row1 = mysql_fetch_array($result1);
if ($row1['status'] == 5) {
    $sql2 = 'INSERT INTO campaignstatus2(name,data,times,campaignid) VALUES("' . $_SESSION['username'] . '","新增預約TOP10媒體",' . time() . ',' . $_GET['id'] . ')';
    mysql_query($sql2);
}
